...
// Function to get user images from the users array using Promises
  ...
  // Function to get user videos from the users array using Promises with an artificial delay
